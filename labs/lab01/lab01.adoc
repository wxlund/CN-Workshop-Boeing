...
. Copy then unpack the downloaded zip file to *CN-Workshop-Boeing/labs/lab01/hello-spring-boot*
+
...
*_STS Import Help:_*
+
Select File > Import… Then select Maven > Existing Maven Projects. On the Import Maven Projects page, browse to the /hello-spring-boot directory (e.g. CN-Workshop-Boeing/labs/lab01/hello-spring-boot)
...
. In a terminal, change working directory to *CN-Workshop-Boeing/labs/lab01/hello-spring-boot*
+
$ cd /CN-Workshop-Boeing/labs/lab01/hello-spring-boot
