...
+
$ cd CN-Workshop-Boeing/labs/lab03

. Copy your progress from lab02 to lab03
+
$ cp -rf ../lab02/hello-spring-boot .

. Rename project to _hello-spring-boot-actuator_
+
$ mv hello-spring-boot hello-spring-boot-actuator
+
Be sure your current working directory is CN-Workshop-Boeing/labs/lab03
+
...
. Edit the following file: *CN-Workshop-Boeing/labs/lab03/hello-spring-boot-actuator/pom.xml*. Add the _git-commit-id-plugin_ to your Maven build. You must edit the file. The _git-commit-id-plugin_ adds Git branch and commit coordinates to the */info* endpoint:
+
[source, xml]
---------------------------------------------------------------------
<plugin>
